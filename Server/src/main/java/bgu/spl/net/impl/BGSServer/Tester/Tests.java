package bgu.spl.net.impl.BGSServer.Tester;

import bgu.spl.net.impl.BGSServer.TPCMain;
    ...
    public String testRegisterCourseWithKdam(){
        ...
        try {
            ...
            if(numTimesSuccess != (int)(actualSpots*4+4+numberOfExtraSpacesInKdam) ||
                    numTimesRegistered != actualSpots||
                    numTimesUnsuccessful!=(8-numberOfExtraSpacesInKdam*2)
